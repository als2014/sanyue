...
Route::post('api/:ver/wechat_login','api/:ver.wechat/login');
//Route::get('api/:ver/member','api/:ver.member/index');
Route::post('api/:ver/member_add','api/:ver.member/add');

Route::post('api/:ver/publish','api/:ver.publish/index');
//图片上传接口
Route::post('api/:ver/upload','api/:ver.upload/index');
